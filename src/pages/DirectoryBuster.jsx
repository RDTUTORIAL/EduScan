...
const DirectoryBuster = () => {
  ...
  return (
    <motion.section className="flex flex-col gap-6" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
      <header className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-white/5 bg-gradient-to-r from-purple-900/30 to-slate-900/50 p-6">
        <div>
          ...
          <div className="glass-panel space-y-3 p-6">
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              ...
              {result?.entries?.map((entry) => (
                ...
                >
                  <span className="font-mono text-slate-200">{entry.path}</span>
